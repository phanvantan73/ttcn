...
@section('title', 'Truyện Hoàn Thành')

@section('sub-category', 'Truyện Đã Hoàn Thành')

@section('sub-sidebar')
    <a class="nav-link" href="{{ route('newest.stories') }}">Mới Cập Nhật</a>
    <a class="nav-link active" href="{{ route('finish.stories') }}">Đã Hoàn Thành</a>
@endsection
            ...
            <li class="with-border">
                ...
                <div class="flex-primary">
                    ...
                    <ul class="tag-list tag-small list-unstyled mt-2">
                        <li class="tag red">
                            <a href="https://truyenyy.com/tim-kiem/nang-cao/?status=C" target="_blank">Còn tiếp...</a>
                        </li>
                        <li class="tag red">
