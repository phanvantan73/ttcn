...
@section('story-info')
    ...
    <div class="info">
        ...
        <ul class="tag-list list-unstyled">
            <li class="tag red">
                <a href="https://truyenyy.com/tim-kiem/nang-cao/?status=C" target="_blank">
                    Còn tiếp...
                </a>
            </li>
        </ul>
...
@section('nav-tabs')
    <li class="nav-item">
        <a class="nav-link" href="{{ route('detail.stories', $story->id) }}" id="intro">
            Giới Thiệu
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" href="{{ route('get.list.chaps', $story->id) }}" id="list-chaps">
            Danh Sách Chương
        </a>
    </li>
    <li class="nav-item">
...
@section('left-col')
    ...
    <div class="row">
        <div class="col">
            <a href="#" class="btn btn-outline-primary btn-sm float-right" target="_blank">
