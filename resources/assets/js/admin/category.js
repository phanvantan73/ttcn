    ...
    $("#save-category").click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                let arrayLabel = ["label-primary", "label-success", "label-info", "label-danger", "label-warning"];
                let category = '<tr id="category' + data.id + '"><td><span class="label ' + arrayLabel[Math.floor(Math.random() * 5)] + '">'
                    + data.name + '</span></td><td>' + data.description + '</td>';
